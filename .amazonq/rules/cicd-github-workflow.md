...
3. Send this message verbatim and wait for confirmation before Phase 1:  
   > "🚀 **AWS Business Group CI/CD Workflow Generation** – Phases: 1) Detect & plan 2) Generate workflow 3) Review & confirm 4) Commit & push. Confirm you understand the process and are ready to begin Phase 1 (Detect & Plan)."
