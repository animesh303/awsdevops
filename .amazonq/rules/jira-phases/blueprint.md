...
4. Use the Atlassian MCP to assign the ticket to current user and set the status to in progress.
5. Extract highlights (description, acceptance criteria, dependencies) into `ticket-{KEY}-extracted.md`, log the action, update `jira-state.md`, and remind the user to commit artifacts.
