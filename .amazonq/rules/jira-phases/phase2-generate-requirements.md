...
- Generate an AWS architecture diagram (via `aws-diagram-mcp-server`) whenever the ticket contains enough detail, embed it in the doc, and store the PNG beside the requirements file.
